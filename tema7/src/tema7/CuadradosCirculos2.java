...
public class CuadradosCirculos2 extends JPanel { 
	...
	public static void main(String[] args) { 
		...
		ventana.setTitle("Cuadrados y Circulos 2");
		...
		//ventana.add(obj);
         ventana.add(new CuadradosCirculos2()); //sustituye a las 2 líneas anteriores
